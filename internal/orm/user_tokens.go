...
var UserTokenTableColumns = struct {
	...
	ID:        "user_tokens.id",
	CreatedAt: "user_tokens.created_at",
	UpdatedAt: "user_tokens.updated_at",
	RemovedAt: "user_tokens.removed_at",
	Meta:      "user_tokens.meta",
...
var UserTokenWhere = struct {
	...
	RemovedAt: whereHelpernull_Time{field: "\"user_tokens\".\"removed_at\""},
	Meta:      whereHelpertypes_JSON{field: "\"user_tokens\".\"meta\""},
	UserID:    whereHelpernull_Int64{field: "\"user_tokens\".\"user_id\""},
}
...
var (
	userTokenAllColumns            = []string{"id", "created_at", "updated_at", "removed_at", "meta", "user_id"}
	userTokenColumnsWithoutDefault = []string{"removed_at", "meta", "user_id"}
